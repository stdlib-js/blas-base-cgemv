...
var cgemv = require( './../lib/ndarray.js' );
...
tape( 'the function has an arity of 15', function test( t ) {
	t.strictEqual( cgemv.length, 15, 'returns expected value' );
	t.end();
});
...
tape( 'the function throws an error if provided an invalid first argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			cgemv( value, data.M, data.N, new Complex64( data.alpha[0], data.alpha[1] ), new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Complex64( data.beta[0], data.beta[1] ), new Complex64Array( data.y ), data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid second argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			cgemv( data.trans, value, data.N, new Complex64( data.alpha[0], data.alpha[1] ), new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Complex64( data.beta[0], data.beta[1] ), new Complex64Array( data.y ), data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid third argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			cgemv( data.trans, data.M, value, new Complex64( data.alpha[0], data.alpha[1] ), new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Complex64( data.beta[0], data.beta[1] ), new Complex64Array( data.y ), data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid tenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			cgemv( data.trans, data.M, data.N, new Complex64( data.alpha[0], data.alpha[1] ), new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), value, data.offsetX, new Complex64( data.beta[0], data.beta[1] ), new Complex64Array( data.y ), data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid fourteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			cgemv( data.trans, data.M, data.N, new Complex64( data.alpha[0], data.alpha[1] ), new Complex64Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex64Array( data.x ), data.strideX, data.offsetX, new Complex64( data.beta[0], data.beta[1] ), new Complex64Array( data.y ), value, data.offsetY );
		};
	}
});
...
tape( 'if either `M` or `N` is `0`, the function returns the second input vector unchanged (row-major)', function test( t ) {
	...
	out = cgemv( data.trans, 0, data.N, alpha, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, beta, y, data.strideY, data.offsetY );
	t.strictEqual( out, y, 'returns expected value' );
	t.strictEqual( isSameComplex64Array( out, expected ), true, 'returns expected value' );

	out = cgemv( data.trans, data.M, 0, alpha, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, beta, y, data.strideY, data.offsetY );
	t.strictEqual( out, y, 'returns expected value' );
	t.strictEqual( isSameComplex64Array( out, expected ), true, 'returns expected value' );
